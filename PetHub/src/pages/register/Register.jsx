...
theme: "colored", 
  ...
  <form onSubmit={handleRegister} className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96 py-6 rounded-md px-6 shadow-md">
    ...
    <button
      className="mt-6 block w-full select-none rounded-lg bg-[#ff0000] py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-yellow-700/20 transition-all hover:shadow-lg hover:shadow-yellow-700/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
  ...
  <p className='md:w-96 text-sm text-center'>By continuing, you agree to our <span className='font-bold'>Terms of Service</span>; Opens a new tab and acknowledge you've read our Privacy Policy; Opens a new tab. </p>
  {/* {
