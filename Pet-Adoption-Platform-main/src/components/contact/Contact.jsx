...
<img src={contact} className='w-96 header' alt="" data-aos="zoom-in-up" />
  ...
  <div data-aos='fade-up'
    ...
    <h3 className="block font-sans text-3xl antialiased font-semibold leading-snug tracking-normal  text-yellow-700">
     Send Message
    </h3>
  </div>
  ...
  <div className="p-6 ">
   <input type='submit' className='w-full bgg cursor-pointer text-white font-bold bg-yellow-700  rounded-full py-3' value='Send'/>
    {/* <button
